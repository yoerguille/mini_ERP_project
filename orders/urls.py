...
from .views import OrderDetailView, OrderListView, OrderCreateView, OrderDeleteView, OrderUpdateView, ChangeStatusView, OrderItemDelete, OrderSentEmail, OrderDraftView
...
urlpatterns = [
    ...
    path('/draft/<pk>', OrderDraftView.as_view(), name='order_draft'),
]
